...
response.sendRedirect("checkAuthorized.jsp"); return; 
        ...
        <div class="searchZone">
            ...
            <form action="SearchProducyByUserIDController" method="post">
                <!-- chỗ nhập tên để search -->
                <input type="text" name="searchBox" placeholder="Search ..." /> Price: <input type="number" name="minPrice" style="width: 120px; height: 15.333px;" value="<fmt:formatNumber value='${minPrice}' pattern='#.##'/>" placeholder="đ Từ">
